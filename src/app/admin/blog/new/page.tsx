        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-500 text-sm mt-0.5">Write a new blog article</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-6 lg:p-8 space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-zinc-900/80 border border-zinc-800 text-zinc-200 placeholder-zinc-600 text-sm focus:border-red-500/50 focus:ring-1 focus:ring-red-500/20 outline-none transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-zinc-900/80 border border-zinc-800 text-zinc-200 placeholder-zinc-600 text-sm font-mono focus:border-red-500/50 focus:ring-1 focus:ring-red-500/20 outline-none transition-all"
            />
          </div>
