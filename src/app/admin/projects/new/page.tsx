      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-0.5">Add a project to your portfolio</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-6 lg:p-8 space-y-5">
          <div className="grid sm:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} required
                className="w-full px-4 py-3 rounded-xl bg-zinc-900/80 border border-zinc-800 text-zinc-200 placeholder-zinc-600 text-sm focus:border-red-500/50 outline-none" />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} required rows={3}
              className="w-full px-4 py-3 rounded-xl bg-zinc-900/80 border border-zinc-800 text-zinc-200 placeholder-zinc-600 text-sm focus:border-red-500/50 outline-none resize-none" />
          </div>

          <div>
            <label className="block text-xs text-zinc-500 uppercase tracking-wider mb-2 font-accent">Tech Stack (comma separated)</label>
            <input type="text" value={tech} onChange={(e) => setTech(e.target.value)} placeholder="React, Node.js, MongoDB"
              className="w-full px-4 py-3 rounded-xl bg-zinc-900/80 border border-zinc-800 text-zinc-200 placeholder-zinc-600 text-sm focus:border-red-500/50 outline-none" />
          </div>
          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm text-zinc-300">Featured (show on homepage)</span>
            </label>
          </div>
